...
with(data, {
  ...
  legend("topright", lty=1, inset=0.0, y.intersp=0.7, col=c("black", "red", "blue"), legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
})

# copy plot to png file
dev.copy(png, file="assignment-solution/plot3.png")
dev.off()
